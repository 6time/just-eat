...
<html lang="ko">
   ...
   <body>
      <form action="/health" method="post">
         ...
         <p><input type="radio" id="health" name="exercise" value="1">아주 가볍게<br>
            <font size="2">&nbsp; &nbsp; &nbsp;호흡에 변함이 없는 정도<br>
                &nbsp; &nbsp; &nbsp;스트레칭</font></p>
         <p><input type="radio" id="health" name="exercise" value="2">조금 가볍게<br>
            <font size="2">&nbsp; &nbsp; &nbsp;숨이 깊어지지만, 편히 대화할 수 있는 정도<br>
                 &nbsp; &nbsp; &nbsp;걷기, 가벼운 근력 회복 운동</font></p>
         <p><input type="radio" id="health" name="exercise" value="3">보통<br>
            <font size="2">&nbsp; &nbsp; &nbsp;대화하기엔 숨쉬기 다소 힘든 정도<br>
                 &nbsp; &nbsp; &nbsp;적당한 달리기, 중강도 운동</font></p>
         <p><input type="radio" id="health" name="exercise" value="4">조금 강하게<br>
            <font size="2">&nbsp; &nbsp; &nbsp;숨이 많이 차고 숨쉬기 힘든 정도<br>
                 &nbsp; &nbsp; &nbsp;빠른 달리기, 고강도 근력 운동</font></p>
         <p><input type="radio" id="health" name="exercise" value="5">아주 강하게<br>
            <font size="2">&nbsp; &nbsp; &nbsp;숨쉬기 매우 힘들고 극도로 힘이 드는 정도<br>
                 &nbsp; &nbsp; &nbsp;전력으로 달리기 등</font></p>

         <b>주 몇회 운동하시나요?</b><br>
         <p>
            <input type="radio" id="health" name="exerciseNumber" value="1">주 0회<br>
            <input type="radio" id="health" name="exerciseNumber" value="2">주 1~3회<br>
            <input type="radio" id="health" name="exerciseNumber" value="3">주 4~6회<br>
            <input type="radio" id="health" name="exerciseNumber" value="4">주 7회<br>
         </p>
      </form>
         <p></p>
